# dbricks_dlt_medallion

The 'dbricks_dlt_medallion' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbricks_dlt_medallion_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dbricks_dlt_medallion.job.yml). The schedule
